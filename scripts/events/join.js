...
.catch(error => {
    ...
    try {
      ...
      (typeof threadData.customJoin == "undefined") ? msg = `🌸❝"𝐀𝐬𝐬𝐚𝐥𝐚𝐦𝐮𝐚𝐥𝐢𝐤𝐨𝐦-!:'༊!!-🦋 {name}\nWelcome to {threadName}\nyou're the {soThanhVien}th member on this group গ্রুঁপেঁরঁ প্ঁক্ষঁ থে্ঁকে্ঁ আঁপঁনাঁকেঁ জা্ঁনা্ঁইঁ হা্ঁজা্ঁর্ঁ হা্ঁজা্ঁর্ঁ লা্ঁল্ঁ গো্ঁলা্ঁপে্ঁর্ঁ শু্ঁভে্ঁচ্ছা্ঁ 🌹🥀★★ 💕🍃🌹🍃💕
💕.•°``°•.¸.•°``°•.💕
💕(  Welcome     ) 💕
💕`•.¸   💗   ¸.•` 💕
     💕° •.¸¸.•° 💕  
...
　　   ┊┊🤍         
　　   ┊ ] 💟
আ্ঁশা্ঁ ক্ঁরি্ঁ আ্ঁপ্ঁনি্ঁ আ্ঁপ্ঁনা্ঁর্ঁ মু্ঁল্য্ঁবা্ঁন্ঁ স্ঁম্ঁয়্ঁ আ্ঁমা্ঁদে্ঁর্ঁ উ্ঁপ্ঁহা্ঁর্ঁ দি্ঁবে্ঁন্ঁ ❁❁❁❁আ্ঁমা্ঁদে্ঁর্ঁ ☆⋆⃝➠̶̶̶̶̶̶᭄🌹গু্ঁরু্ঁপ্ঁ টা্ঁ এ্ঁগি্ঁয়ে্ঁ নি্ঁয়ে্ঁ যা্ঁও্ঁয়া্ঁর্ঁ জ্ঁন্য্ঁ স্ঁহ্ঁযো্ঁগিতা্ঁ ক্ঁর্ঁবে্ঁন্ঁ✾✾❀ 

🌸𝗡𝗢𝗕𝗜𝗧𝗔 𝗔𝗡𝗗 𝗔𝗟𝗟 𝗖𝗘𝗢 𝗣𝗘𝗥𝗦𝗢𝗡🌺 
